...
class Concept2Loading extends StatefulWidget {
  String idUser;
  Concept2Loading({this.idUser});

  @override
  _Concept2LoadingState createState() => _Concept2LoadingState();
}

class _Concept2LoadingState extends State<Concept2Loading> {
