...
class ProgressCircleConcept2 extends StatefulWidget {
  ProgressCircleConcept2({Key key}) : super(key: key);

  @override
  _ProgressCircleConcept2State createState() => _ProgressCircleConcept2State();
}

class _ProgressCircleConcept2State extends State<ProgressCircleConcept2> {
