...
class Concept4List extends StatefulWidget {
  Concept4List({Key key}) : super(key: key);

  _Concept4ListState createState() => _Concept4ListState();
}

class _Concept4ListState extends State<Concept4List> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            _card(
                "08 April 2019", "MEDICAL CHECK UP", "Payment", "-5.200 Point"),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text(
                value,
                style: TextStyle(color: Color(0xFF4d2a86), fontFamily: "Sans"),
              )
            ],
          ),
        ),
